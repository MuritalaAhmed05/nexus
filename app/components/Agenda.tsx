...
const Agenda: React.FC = () => {
  ...
  // Animation variants with explicit Variants typing to resolve "ease" errors
  ...
  return (
    ...
    >
      <div className="max-w-4xl md:max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-4 md:gap-0">
        ...
        <motion.p
          className="text-base md:text-lg lg:text-[20px] font-normal text-left md:text-right leading-tight font-syne"
